 ...
 */
@SessionScoped
public class RedmineManagerProducer implements Serializable{
    ...
    @Produces
    public RedmineManager newRedmineManager() {
        return RedmineManagerFactory.createWithApiKey(REDMINE_HOST, API_ACCESS_KEY);
    }
